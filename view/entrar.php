  ...
  <header>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="entrar.php"><i class="fas fa-user-circle"></i>Entrar <span class="sr-only">(current)</span></a>
      </li>
	...
	<div class="login-caixa">
		...
		<div class="caixa-texto">
			<i class="fas fa-user"></i><input type="email" name="email" placeholder="Usuário" required="required">
		</div>

		<div class="caixa-texto">
			<i class="fas fa-lock"></i><input type="password" name="password" placeholder="Senha" required="required">
			<input class="btn btn-dark" type="button" value="Logar">
		</div>
