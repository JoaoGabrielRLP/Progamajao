...
<!-- Inicio do cabeçalho -->
  <header>
    ...
    <ul class="navbar-nav">
      ...
      <div class="dropdown-menu bg-light" aria-labelledby="navbarDropdownMenuLink">
        ...
        <a class="dropdown-item active" href="acessorios.php"><i class="fas fa-headphones"></i>Acessórios <span class="sr-only">(current)</span></a>
   ...
   <div id="foto-acessorios">
      <div class="espaco-acessorios">
      <span class="titulo-acessorios"> Acessórios</span>
      </div>
    </div>
  ...
  <div class="jumbotron bg bg-dark">
    ...
    <h1 class="display-4 text-primary">HeadSets</h1>
...
<div class="card-deck">
  ...
  <div class="card">
    <img class="card-img-top" src="../imagens/fone2.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Headset Knup kp-400</h5>
...
<div class="card-deck">
  ...
  <div class="card">
    <img class="card-img-top" src="../imagens/fone4.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Headset Infokit bass GH-X1000</h5>
  ...
  <div class="card">
    <img class="card-img-top" src="../imagens/fone5.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Fortrek Pro H2 P2/USB LED Azul</h5>
      <p class="card-text">R$ 76,90</p>
    ...
    <div class="jumbotron bg bg-dark">
    <div class="cartoes-carousel">
    <h1 class="display-4 text-primary">Teclados</h1>
        <div class="blogs owl-carousel">
...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Redgradon Kumara RGB</h5>
  ...
  <div class="card">
    <img class="card-img-top" src="../imagens/teclado3.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Razer BlackWidow Ultimate Stealth</h5>
...
<div class="card-deck">
  ...
  <div class="card">
    <img class="card-img-top" src="../imagens/teclado4.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Logitech G613 Romer G taticle</h5>
  ...
  <div class="card">
    <img class="card-img-top" src="../imagens/teclado5.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Exbom semi-mecânico BK-G200</h5>
  ...
  <div class="card">
    <img class="card-img-top" src="../imagens/teclado6.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">T-DAGGER Bora switch azu</h5>
